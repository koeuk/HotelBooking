            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-primary/10 dark:from-primary/10 dark:via-zinc-950 dark:to-primary/5">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
                    <Badge variant="secondary" className="mb-4">
                        <Award className="h-3 w-3 mr-1" /> Trusted by 50,000+
                        travelers
                    </Badge>
                    ...
                    <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                        ...
                        transparent, and delightful for travelers worldwide.
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-2 text-muted-foreground max-w-xl mx-auto">
                        We go beyond just booking. Here's what makes us
                        different.
                    </p>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="mt-6 space-y-4 text-muted-foreground">
                                <p>
                                    Founded with a passion for travel, HotelBook
                                    was created to solve a simple problem:
                                    finding and booking the perfect hotel
                                    shouldn't be complicated or stressful.
                                </p>
                                <p>
                                    We started as a small team of travel
                                    enthusiasts who were frustrated with the
                                    existing booking experience. Hidden fees,
                                    confusing interfaces, and unreliable reviews
                                    made planning trips a headache. We knew
                                    there had to be a better way.
                                </p>
                                <p>
                                    Today, HotelBook connects travelers with
                                    exceptional accommodations in over 120
                                    cities worldwide. Our platform features
                                    transparent pricing, verified user reviews,
                                    and real-time availability — everything you
                                    need to make the best choice for your next
                                    trip.
                                </p>
                                <p>
                                    Whether you're planning a business trip, a
                                    family vacation, or a solo adventure,
                                    HotelBook is here to help you find your
                                    ideal stay at the best possible price.
                                </p>
                            </div>
            ...
            <section className="bg-zinc-50 dark:bg-zinc-900/50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-2 text-muted-foreground">
                            Trusted by leading brands in the travel industry.
                        </p>
                    </div>
