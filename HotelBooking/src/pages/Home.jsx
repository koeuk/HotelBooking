          ...
          <div className="max-w-2xl">
            ...
            <p className="text-white/65 text-xl mt-6 mb-10 leading-relaxed max-w-xl">
              {hotel?.description?.slice(0, 140) ||
                "Experience unparalleled luxury and comfort in the heart of the city. Your perfect stay awaits."}
            </p>
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Carefully designed spaces for your comfort
            </p>
          </div>
          <Link
            to="/rooms"
          ...
          <div className="bg-card rounded-3xl p-10 md:p-16 shadow-warm border border-border">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {AMENITIES.map((amenity, index) => (
                ...
                >
                  <div className="text-green-800 w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all">
                    {amenity.icon}
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              {hotel?.description ||
                "Nestled in a prime location, our hotel combines timeless elegance with modern comforts. Whether you're here for business or leisure, we offer tailored experiences, world-class dining, and spaces designed to make every moment memorable."}
            </p>
