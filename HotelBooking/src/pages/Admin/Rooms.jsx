      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 flex flex-wrap gap-4 items-end">
        ...
        <div className="flex flex-col gap-1 min-w-[160px]">
          ...
          <select
            ...
            onChange={(e) =>
              setFilters((f) => ({ ...f, room_type_id: e.target.value }))
            }
          ...
          >
            ...
            {roomTypes.map((rt) => (
              <option key={rt.uuid || rt.id} value={rt.uuid || rt.id}>
                {rt.name}
              </option>
            ))}
          </select>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-xs font-semibold capitalize ${STATUS_COLORS[room.status] || STATUS_COLORS.available}`}
                        >
                      ...
                      <td className="px-5 py-4">
                        <select
                          ...
                          onChange={(e) =>
                            handleStatusChange(roomId, e.target.value)
                          }
