...
import { CalendarCheck, Clock, CheckCircle, XCircle, SlidersHorizontal } from 'lucide-react';
...
const ALL_STATUSES = ['pending', 'confirmed', 'checked_in', 'checked_out', 'cancelled', 'completed'];
                                ...
                                {bookings.map(booking => {
                                    ...
                                    return (
                                        <tr key={booking.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                                            <td className="px-5 py-3.5 text-slate-400 font-mono text-xs">#{booking.id}</td>
                                            ...
                                            <td className="px-5 py-3.5 text-slate-500">{checkIn || '—'}</td>
                                            <td className="px-5 py-3.5 text-slate-500">{checkOut || '—'}</td>
                                            <td className="px-5 py-3.5 text-slate-500">{calcNights(checkIn, checkOut)}</td>
