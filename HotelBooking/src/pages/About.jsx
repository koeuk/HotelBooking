      ...
      <section className="relative overflow-hidden py-24 px-4">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-white/65 text-xl leading-relaxed max-w-2xl mx-auto">
            We make finding and booking the perfect hotel simple, fast, and
            affordable — whether you're travelling for business or leisure.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {stats.map((s, i) => (
            ...
            >
              <div className="text-green-800 inline-flex items-center justify-center w-11 h-11 bg-primary/10 rounded-xl mb-3">
                {s.icon}
              </div>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-16">
        <div className="bg-card rounded-3xl border border-border shadow-warm p-10 mb-8">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            HotelStay was built with one goal: remove the friction from hotel
            booking. We partner with hotels across the globe to offer real-time
            availability, transparent pricing, and a seamless checkout
            experience — so you spend less time planning and more time enjoying
            your stay.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {values.map((v, i) => (
            ...
            >
              <div className="text-green-800 inline-flex items-center justify-center w-11 h-11 bg-primary/10 rounded-xl mb-4">
                {v.icon}
              </div>
      ...
      <section className="relative overflow-hidden py-20 px-4 mb-0">
        ...
        <div className="relative z-10 text-center max-w-xl mx-auto">
          ...
          <p className="text-white/70 mb-8 text-lg">
            Browse our rooms and book in seconds.
          </p>
          <Link
            to="/rooms"
            className="text-green-800 inline-flex items-center gap-2 bg-white font-bold px-10 py-4 rounded-2xl transition-colors shadow-warm"
          >
