            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
                <div className="bg-white rounded-2xl shadow-2xl shadow-black/20 p-2 flex flex-wrap gap-2 items-center">
                    ...
                    <div className="flex flex-col min-w-[130px]">
                        <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider px-3 pt-1">Status</label>
                        <select
                ...
                {loading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {Array.from({ length: 8 }).map((_, i) => (
                            <div key={i} className="h-72 bg-white/10 rounded-3xl animate-pulse" />
                        ))}
                    </div>
                ) : filtered.length === 0 ? (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="relative h-44 overflow-hidden">
                                        ...
                                        {/* Status badge */}
                                        <span className={`absolute top-3 right-3 text-xs font-bold px-2.5 py-1 rounded-full capitalize ${STATUS_STYLES[room.status] || STATUS_STYLES.available}`}>
                                            {room.status}
                                        </span>
                                    ...
                                    <div className="p-4 flex flex-col flex-1">
                                        ...
                                        <div className="flex items-start justify-between mb-2">
                                            <div>
                                                <p className="text-xs font-bold text-primary uppercase tracking-wide">{rt.name}</p>
