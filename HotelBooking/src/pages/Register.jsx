...
import { Mail, Lock, User, Phone, AlertCircle, Star, BedDouble } from 'lucide-react';
...
export default function Register() {
    ...
    const inputClass = "w-full pl-11 pr-4 py-3.5 bg-muted border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-foreground placeholder:text-muted-foreground";
                ...
                <div className="relative z-10 flex flex-col justify-between p-12 h-full">
                    <Link to="/" className="flex items-center gap-2.5">
                        ...
                        <span className="font-display text-white font-semibold text-xl tracking-tight">
                            Hotel<span className="text-primary-light">Stay</span>
                        </span>
                    </Link>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-white/50 text-sm ml-1">5-star experience</span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {[
                            ...
                            { label: 'Exclusive member rates', icon: <BedDouble size={14} /> },
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-16 bg-background">
                <div className="w-full max-w-lg py-8">
                    ...
                    <Link to="/" className="flex items-center gap-2.5 mb-10 lg:hidden">
                        ...
                        <span className="font-display text-foreground font-semibold text-xl">HotelStay</span>
                    </Link>

                    <div className="mb-8">
                        <h1 className="font-display text-4xl font-bold text-foreground mb-2">Create account</h1>
                        <p className="text-muted-foreground">Join us and start booking your dream stays</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input name="name" type="text" onChange={handleChange} className={inputClass} placeholder="John Doe" required />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input name="email" type="email" onChange={handleChange} className={inputClass} placeholder="name@example.com" required />
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input name="phone" type="text" onChange={handleChange} className={inputClass} placeholder="+1 (555) 000-0000" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground" size={16} />
                                    <input name="password_confirmation" type="password" onChange={handleChange} className={inputClass} placeholder="••••••••" required />
                                </div>
                            </div>
                        </div>
