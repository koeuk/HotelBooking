...
function Create({ users, hotels, bookings }) {
  ...
  return /* @__PURE__ */ jsxs(DashboardLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Add Review" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold tracking-tight", children: "Add Review" })
      ] }),
      /* @__PURE__ */ jsx("form", { onSubmit: submit, children: /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: "Enter the details for the new review." })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "booking_id", children: "Booking" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  id: "booking_id",
                  ...
                  className: "flex h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm shadow-xs transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", children: "Select a booking" }),
                    bookings.map((booking) => /* @__PURE__ */ jsxs(
                      "option",
                      {
              ...
              errors.booking_id && /* @__PURE__ */ jsx("p", { className: "text-sm text-destructive", children: errors.booking_id })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs(CardFooter, { className: "flex justify-end gap-4 border-t px-6 py-4", children: [
          ...
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: processing ? "Saving..." : "Create Review" })
        ] })
      ] }) })
    ] })
  ] });
