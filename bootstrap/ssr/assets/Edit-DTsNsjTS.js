...
function Edit({ user }) {
  ...
  const avatarPreview = data.avatar ? URL.createObjectURL(data.avatar) : user.avatar;
  const submit = (e) => {
    e.preventDefault();
  ...
  return /* @__PURE__ */ jsxs(DashboardLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold tracking-tight", children: "Edit User" })
      ] }),
      /* @__PURE__ */ jsx("form", { onSubmit: submit, children: /* @__PURE__ */ jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Click to change (max 2MB)" })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 border-t pt-4", children: [
            /* @__PURE__ */ jsx("div", { className: "space-y-2 col-span-2", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Leave password fields blank to keep the current password." }) }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs(CardFooter, { className: "flex justify-end gap-4 border-t px-6 py-4", children: [
          ...
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: processing ? "Saving..." : "Update User" })
        ] })
      ] }) })
    ] })
  ] });
