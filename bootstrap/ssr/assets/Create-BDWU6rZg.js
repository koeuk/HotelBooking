...
function Create({ hotels, roomTypes }) {
  ...
  return /* @__PURE__ */ jsxs(DashboardLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Add Room" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold tracking-tight", children: "Add Room" })
      ] }),
      /* @__PURE__ */ jsx("form", { onSubmit: submit, children: /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Room Details" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Registry a specific room in a hotel." })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "status", children: "Initial Status" }),
            /* @__PURE__ */ jsxs(
              Select,
              {
                value: data.status,
        ...
        /* @__PURE__ */ jsxs(CardFooter, { className: "flex justify-end gap-4 border-t px-6 py-4", children: [
          ...
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: processing ? "Saving..." : "Create Room" })
        ] })
      ] }) })
    ] })
  ] });
