...
function Create({ hotels }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route("dashboard.room-types.store"), { forceFormData: true });
  };
  return /* @__PURE__ */ jsxs(DashboardLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Add Room Type" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold tracking-tight", children: "Add Room Type" })
      ] }),
      /* @__PURE__ */ jsx("form", { onSubmit: submit, children: /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: "Set up a new category of room for booking." })
        ] }),
        ...
        /* @__PURE__ */ jsxs(CardFooter, { className: "flex justify-end gap-4 border-t px-6 py-4", children: [
          ...
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: processing ? "Saving..." : "Create Room Type" })
        ] })
      ] }) })
    ] })
  ] });
