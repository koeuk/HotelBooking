...
function Create({ users, rooms }) {
  ...
  return /* @__PURE__ */ jsxs(DashboardLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Create Booking" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold tracking-tight", children: "Create Booking" })
      ] }),
      /* @__PURE__ */ jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs(
              "select",
              {
                ...
                children: [
                  ...
                  rooms.map((room) => /* @__PURE__ */ jsxs("option", { value: room.id, children: [
                    room.hotel.name,
                    " -",
                    " ",
                    room.room_type.name,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex gap-3 justify-end", children: [
            ...
            /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: "Create Booking" })
          ] })
        ] }) })
      ] })
    ] })
