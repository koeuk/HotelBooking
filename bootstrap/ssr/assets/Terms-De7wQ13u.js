...
import { ShieldCheck, UserCheck, CalendarX, CreditCard, AlertTriangle, Scale, Gavel, FileText } from "lucide-react";
  ...
  return /* @__PURE__ */ jsx(
    LegalDocument,
    {
      ...
      headline: /* @__PURE__ */ jsxs(Fragment, { children: [
        "The",
        " ",
        /* @__PURE__ */ jsx("span", { className: "italic font-serif font-medium text-gradient-primary", children: "fine print" }),
        ", made readable."
      ] }),
