...
| ------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| **users**           | id, uuid, name, email, password, phone, role (user/admin), google_id, facebook_id, avatar                               | hasMany: bookings                                            |
...
| **room_types**      | id, uuid, hotel_id, name, description, max_users, price_per_night, images                                               | belongsTo: hotel; hasMany: rooms                             |
...
| **Reviews**    | Resource CRUD        | Index, Create, Edit | user review moderation                                                         |
...
| **BookingStatusUpdatedUserNotification** | Status changed to confirmed/cancelled/completed | Mail, Database           | user      |
| **PaymentReceivedNotification**          | Payment recorded as paid                        | Mail, Database, Telegram | user      |
...
```
user selects hotel → Chooses room type → Picks dates
...
| User Review Submission   | Medium   | Allow users to submit reviews from their dashboard   |
