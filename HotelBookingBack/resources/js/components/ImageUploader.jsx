        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                        Upload multiple photos or provide URLs.
                    </p>
                </div>
            ...
            >
                ...
                {existingImages.map((url, index) => (
                    <div
                        key={`existing-${index}`}
                        className="relative group aspect-video animate-in zoom-in-95 duration-200"
                    >
                        <img
                            src={url}
                            alt={`Image ${index + 1}`}
                ...
                {previews.map((preview, index) => (
                    ...
                    >
                        ...
                        />
                        <div className="absolute top-2 left-2 bg-primary text-green-800-foreground px-2 py-0.5 rounded-full text-[10px] font-bold shadow-sm">
                            New
                        </div>
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center">
                            <button
                ...
                >
                    <div className="h-10 w-10 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center group-hover:bg-primary/10 group-hover:text-green-800 transition-colors">
