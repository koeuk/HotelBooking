                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600 p-8 text-white shadow-lg">
                    ...
                    <div className="relative">
                        ...
                        <p className="mt-2 text-white/80 max-w-lg">
                            Welcome to your hotel booking dashboard. View your
                            reservations, track your stays, and discover new
                            destinations.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                                ...
                                {upcomingBookings.length > 0 ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center py-12 text-center">
                                        ...
                                        <p className="text-sm text-muted-foreground mt-1">
                                            Your next trips will appear here
                                        </p>
                                    </div>
                                )}
                            </CardContent>
                        ...
                        <Card className="border-none shadow-sm">
                            <CardHeader className="pb-3">
                                ...
                                <CardDescription>
                                    Your latest reservation history
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {recentBookings.length > 0 ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center py-12 text-center">
                                        ...
                                        <p className="text-sm text-muted-foreground mt-1">
                                            Your reservation history will show
                                            here
                                        </p>
                                    </div>
                                )}
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="border-none shadow-sm bg-gradient-to-br from-slate-50 to-slate-100">
                            <CardContent className="p-6">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                    Contact our support team for any booking
