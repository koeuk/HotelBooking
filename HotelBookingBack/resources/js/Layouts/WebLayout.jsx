                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        >
                            ...
                            <span className="text-xl font-bold tracking-tight">
                                Hotel
                                <span className="text-green-800">Book</span>
                            </span>
                        </Link>
                                            ...
                                            >
                                                <Avatar className="h-9 w-9">
                                                    <AvatarImage
                                                        src={user.avatar}
                                                    />
                                                    <AvatarFallback className="bg-primary/10 text-green-800 font-bold text-sm">
                                                        {user.name?.charAt(0)}
                                                    </AvatarFallback>
                                                </Avatar>
                                            </Button>
            ...
            <footer className="bg-zinc-50 dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="md:col-span-1">
                            <Link href="/" className="flex items-center gap-2">
                                <div className="h-8 w-8 rounded-lg bg-primary flex items-center justify-center text-green-800-foreground font-bold text-xl">
                                    H
                                </div>
                                <span className="text-xl font-bold tracking-tight">
                                    Hotel
                            ...
                            <p className="mt-3 text-sm text-muted-foreground">
                                Find and book the perfect hotel for your next
                                adventure. Best prices guaranteed.
                            </p>
                        </div>
                        <div>
                    ...
                    <div className="mt-8 pt-8 border-t border-zinc-200 dark:border-zinc-800 text-center text-xs text-muted-foreground">
                        &copy; {new Date().getFullYear()} HotelBook. All rights
                        reserved.
                    </div>
                </div>
            </footer>
