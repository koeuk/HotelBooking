    ...
    <table role="presentation" align="center" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.06);">
        <tr>
            <td style="background:linear-gradient(135deg,#6366f1,#8b5cf6); padding:28px 28px 22px; color:#fff;">
                ...
                <h1 style="margin:6px 0 0; font-size:22px; line-height:1.3;"><?php echo e($subjectLine); ?></h1>
            </td>
        </tr>
        <tr>
            <td style="padding:24px 28px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px; line-height:1.5;">
                    <tr>
                        ...
                        <td style="padding:6px 0; color:#111;"><?php echo e($senderName); ?></td>
                    </tr>
                    <tr>
                        <td style="padding:6px 0; color:#6b7280;">Email</td>
                        <td style="padding:6px 0;"><a href="mailto:<?php echo e($senderEmail); ?>" style="color:#6366f1; text-decoration:none;"><?php echo e($senderEmail); ?></a></td>
                    </tr>
                </table>
                ...
                <div style="background:#f6f7fb; border-radius:12px; padding:16px; white-space:pre-wrap; font-size:14px; line-height:1.6; color:#111;"><?php echo e($body); ?></div>

                <p style="margin:24px 0 0; font-size:12px; color:#9ca3af;">
                    Reply directly to this email to respond to <?php echo e($senderName); ?>.
                </p>
            </td>
        </tr>
    </table>
...
<?php /**PATH /home/koeuk/Desktop/HotelBooking/resources/views/mail/contact-message.blade.php ENDPATH**/ ?>